        ...
        <div className="p-8">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold text-blue-600">
              H<span className="inline-flex items-center justify-center w-10 h-10 rounded-full border-4 border-blue-600 mx-1">⊕</span>MIN+
            </h1>
            <p className="mt-4 text-gray-600">
              {isLogin ? 
                (isAdminLogin ? 'Acesso Administrativo' : 'Faça login na sua conta') 
                : 'Crie sua conta'}
            </p>
          </div>
